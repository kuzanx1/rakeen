...
/**
 * الحدُّ الذي يصير الخطُّ بعده «كبيراً» فيأخذ سطراً أوسع.
 *
 * اسمُ المنشأة ورقمُ الطلب فوقه، وسائرُ السطور دونه. وكان عدداً عارياً
 * في موضعين من الراسم -- يُغيَّر أحدُهما ويبقى الآخر، فيتنفّس عنوانٌ
 * ولا يتنفّس نظيرُه.
 */
export const LARGE_TYPE_ABOVE = 22;
 ...
 * تذكرةُ المطبخ.
 *
 * ورقةٌ أخرى لا فاتورةٌ مختصرة: تُقرأ بسرعةٍ فوق طاولةٍ حارّة، فخطُّها
 * أكبر، ولا مالَ فيها البتّة -- لا سعرَ ولا ضريبةَ ولا طريقةَ دفع.
 * ولذلك مقاساتُها مستقلّة، ولا تتبع قالبَ الفاتورة ولا كثافتَه.
 */
...
/** مسافاتُ تذكرة المطبخ. */
export const KITCHEN_SPACE = {
  afterLogo: 0.35,
  beforeCall: 0.2,
  afterRule: 0.6,
  itemLine: 0.9,
 ...
 *
 * وترتيبُه من مراجع التسوية المحاسبية لا من عادةٍ عندنا: مبيعاتٌ ثمّ
 * طرقُ دفعٍ ثمّ صندوقٌ ثمّ توقيع. وكلُّ قسمٍ ينتهي بسطرٍ يُنقل إلى الذي
 * بعده، حتى يستطيع المدقّقُ أن يتتبّع الرقمَ بيده.
 */
export const SHIFT = {
  line: 32,
  businessName: 30,
...
/**
 * القلبُ المرسوم -- نِسَبُ منحنياته.
 *
 * كلُّ عددٍ منها نسبةٌ من حجمه، فيكبر ويصغر بلا أن يتشوّه. وهي هنا لا
 * في المنفّذَين: لو تُركت لهما لَرسم كلٌّ منهما قلباً غيرَ قلب الآخر --
 * وهو أدقُّ ما في الورقة شكلاً، وأظهرُ ما يُرى فيها اختلافاً.
 */
export const HEART = {
  /** ارتفاعُه من عرضه. */
  aspect: 0.9,

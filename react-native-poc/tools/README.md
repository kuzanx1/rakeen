...
| `Could not listen on port 9100` | نسخة قديمة من السكربت شغّالة — الرسالة نفسها تدلّك على الـPID المالك |
| المستمع يقول «listening» ولا يوصله شي، والتطبيق يقول «تمت الطباعة» | نافذة أخرى تملك المنفذ فعلاً. قارن الـPID المطبوع في هذي النافذة بمالك المنفذ، وافحص `tools/received/` — لو فيه ملفات جديدة فالطباعة تصل، بس لنافذة ثانية |
